...
import { getAllBookings, getBookingsByUserId, getBookingsByRoomId, getBookingById, createBooking, updateBooking, deleteBooking } from '../controllers/bookingController';
